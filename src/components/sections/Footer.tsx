...
const footerLinks = {
  product: [
    ...
    { name: "Free Scanner", href: "#scanner" },
    { name: "Changelog", href: "#" },
  ],
  company: [
...
const socialLinks = [
  ...
  { name: "Email", icon: Mail, href: "mailto:hello@smartpics.ai" },
];
...
export default function Footer() {
  return (
    <footer className="relative border-t border-white/5">
      {/* Background Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-purple-600/5 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">SmartPics.ai</span>
            </Link>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} SmartPics.ai. All rights reserved.
          </p>
